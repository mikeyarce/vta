...
mediaheaders = {
	'Authorization': 'Basic bWlrZXlhcmNlOmhxb1kgMDFabSA3ajdnIDlzTzQgZXoyayA3UFFo',
	'Content-Type': 'image/jpeg',
	'Content-disposition': 'attachment; filename=image2.jpg'
}
media = requests.post('https://mikeyarce.mystagingwebsite.com/wp-json/wp/v2/media', headers=mediaheaders, data=image)
...
headers = { 'Authorization': 'Basic bWlrZXlhcmNlOmhxb1kgMDFabSA3ajdnIDlzTzQgZXoyayA3UFFo', 'Content-Type': 'application/x-www-form-urlencoded'}
r = requests.post('https://mikeyarce.mystagingwebsite.com/wp-json/wp/v2/posts',headers=headers,  data = payload)


## Send Temp and PM data to Thingspeak
r2 = requests.get( 'https://api.thingspeak.com/update?api_key=VN3TUHQI1AEDCQR3&field2=' + str(sensor_read.temperature) + '&field3=' + str(sensor_read.humidity) + '&field4=' + str(sensor_read.pressure) + '&field5=' + str(round(pm25avg, 2)) + '&field6=' + str(round(pm10avg, 2)) )
